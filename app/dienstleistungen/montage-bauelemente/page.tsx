...
export default function MontageBauelementePage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[500px] sm:min-h-[600px] bg-gradient-to-br from-dark-blue-gray to-gray-800 flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1567711601167-cd0efb1f8a99?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&h=1080&q=80')",
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-lg sm:text-xl lg:text-2xl font-medium mb-6 sm:mb-8 leading-relaxed max-w-4xl mx-auto">
            Professionelle Montage von Türen, Fenstern, Möbeln und mehr im Rems-Murr-Kreis
          </h2>
          <Button
            size="lg"
      ...
      <section className="py-12 sm:py-16 bg-warm-light-gray">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-medium text-dark-blue-gray mb-4">Meine Montage-Services</h2>
            <p className="text-base sm:text-lg text-gray-700 max-w-3xl mx-auto">
              Von der einfachen Möbelmontage bis zum komplexen Türeinbau
            </p>
          </div>
      ...
      <section id="contact" className="py-12 sm:py-16 bg-dark-blue-gray text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-3xl sm:text-4xl font-medium mb-4">Montage beauftragen</h2>
            <p className="text-lg sm:text-xl opacity-90 max-w-3xl mx-auto">
              Lassen Sie Ihre Möbel und Bauelemente professionell montieren. Kostenvoranschlag inklusive!
            </p>
          </div>

          <div className="max-w-2xl mx-auto">
            <ContactForm preselectedService="montage-bauelemente" />
          </div>
        </div>
      </section>

      {/* Service Navigation */}
      <ServiceNavigation currentService="montage-bauelemente" />
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 sm:hidden">
          <div className="bg-white border-t border-gray-200 p-4 shadow-lg">
            <Button
              ...
              aria-label="Jetzt Montage anfragen - Zum Kontaktformular"
            >
